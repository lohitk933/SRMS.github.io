...
<body>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="6semresult.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="col-4 my-1 mb-3">
                            <label for="inputsub1" class="form-label">SS&C</label>
                            <input type="text" name="sub1Edit" class="form-control" id="sub1Edit" placeholder="18MAT11">
                        </div>
                        <div class="col-4 my-1 mb-3">
                            <label for="inputsub2" class="form-label">CG&V</label>
                            <input type="text" name="sub2Edit" class="form-control" id="sub2Edit" placeholder="18PHY12">
                        </div>
                        <div class="col-4 my-1 mb-3">
                            <label for="inputsub3" class="form-label">WT&A</label>
                            <input type="text" name="sub3Edit" class="form-control" id="sub3Edit" placeholder="18ELE13">
                        </div>
                        <div class="col-4 my-1 mb-3">
                            <label for="inputsub4" class="form-label">DM&W</label>
                            <input type="text" name="sub4Edit" class="form-control" id="sub4Edit" placeholder="18CIV14">
                        </div>
                        <div class="col-4 my-1 mb-3">
                            <label for="inputsub5" class="form-label">MAD</label>
                            <input type="text" name="sub5Edit" class="form-control" id="sub5Edit" placeholder="18GP15">
                        </div>
                        <div class="col-4 my-1 mb-3">
                            <label for="inputsub6" class="form-label">SSL</label>
                            <input type="text" name="sub6Edit" class="form-control" id="sub6Edit" placeholder="18ENG16">
                        </div>
                        <!-- <div class="col-4 my-1 mb-3">
                                <label for="inputtmarks" class="form-label">Total Marks</label>
                                <input type="number" name="tmarksEdit" class="form-control" id="tmarksEdit"
                                    placeholder="Total Marks">
                            </div>
                            <div class="col-4 my-1 mb-3">
                                <label for="inputcent" class="form-label">Percentage</label>
                                <input type="text" name="centEdit" class="form-control" id="centEdit"
                                    placeholder="Percentage">
                            </div>
                            <div class="col-4 my-1 mb-3">
                                <label for="inputgrade" class="form-label">Grade</label>
                                <input type="text" name="gradeEdit" class="form-control" id="gradeEdit"
                                    placeholder="Grade">
                            </div> -->
    ...
    <header>
        <a href="6semresult.php" class="srms"><span>6th Sem Result Details</span></a>
        <nav class="navbar">
            <ul>
        ...
        <table class="table" id="myTable">
            <thead>
                <tr>
                    ...
                    <th scope="col">Sem</th>
                    <th scope="col">Sec</th>
                    <th scope="col">SS&C</th>
                    <th scope="col">CG&V</th>
                    <th scope="col">WT&A</th>
                    <th scope="col">DM&W</th>
                    <th scope="col">MAD</th>
                    <th scope="col">SSL</th>
                    <th scope="col">%</th>
            ...
            <tbody>
                <?php 
                $sql = "SELECT * from result where sem='6th'";
          $result = mysqli_query($conn, $sql);
          $sno = 0;
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this student details!")) {
                    console.log("yes");
                    window.location = `6semresult.php?delete=${sno}`;
