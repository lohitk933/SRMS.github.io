...
<body>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="7semresult.php" method="POST">
    ...
    <header>
        <a href="7semresult.php" class="srms"><span>7th Sem Result Details</span></a>
        <nav class="navbar">
            <ul>
        ...
        <table class="table" id="myTable">
            <thead>
                <tr>
                    ...
                    <th scope="col">BDA</th>
                    <th scope="col">SA&DP</th>
                    <th scope="col">DIP</th>
                    <th scope="col">IBDA</th>
                    <th scope="col">IAI</th>
                    <th scope="col">%</th>
            ...
            <tbody>
                <?php 
                $sql = "SELECT * from result where sem='7th'";
          $result = mysqli_query($conn, $sql);
          $sno = 0;
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this student details!")) {
                    console.log("yes");
                    window.location = `7semresult.php?delete=${sno}`;
