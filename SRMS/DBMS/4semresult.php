...
<body>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="4semresult.php" method="POST">
    ...
    <header>
        <a href="4semresult.php" class="srms"><span>4th Sem Result Details</span></a>
        <nav class="navbar">
            <ul>
  ...
  ?>
    <div class="container my-4">
        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                <?php 
                $sql = "SELECT * from result where sem='4th'";
          $result = mysqli_query($conn, $sql);
          $sno = 0;
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this student details!")) {
                    console.log("yes");
                    window.location = `4semresult.php?delete=${sno}`;
